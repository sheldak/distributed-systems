...
public class IceServer
{
	public void t1(String[] args)
	{
		...
		try	{
			...
			// METODA 2 (niepolecana, dopuszczalna testowo): Konfiguracja adaptera Adapter1 jest w kodzie xrxdxowym
			...
			// 4. Dodanie wpisow do tablicy ASM, skojarzenie nazwy obiektu (Identity) z serwantem
			...
			// 5. Aktywacja adaptera i wejscie w petle przetwarzania żądań
			adapter.activate();
