...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float avg(long[] b)
    {
        return avg(b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(long[] b, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] b)
    {
        return _iceI_avgAsync(b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] b, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(b, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(long[] iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "avg", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeLongSeq(iceP_b);
                 }, istr -> {
                     float ret;
                     ret = istr.readFloat();
                     return ret;
