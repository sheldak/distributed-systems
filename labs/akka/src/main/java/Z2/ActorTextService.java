...
public class ActorTextService extends AbstractBehavior<ActorTextService.Command>  {
    ...
    public ActorTextService(ActorContext<Command> context) {
        ...
        listingResponseAdapter = context.messageAdapter(Receptionist.Listing.class, ListingResponse::new);
    ...
    public Receive<Command> createReceive() {
        ...
        return newReceiveBuilder()
                ...
                .onMessage(ListingResponse.class, this::onRequest)
    ...
    // TODO: handle the new type of message
    private Behavior<Command> onRequest(ListingResponse msg) {
        workers = new LinkedList<>(msg.listing.getServiceInstances(ActorUpperCase.upperCaseServiceKey));
